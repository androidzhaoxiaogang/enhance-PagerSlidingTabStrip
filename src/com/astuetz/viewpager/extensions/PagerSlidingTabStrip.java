/*
 * Copyright (C) zhao xiaogang <zxgangandy@gmail.com>
 *
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int tabTextSelectColor = Color.parseColor("#900707");
	...
	public void setTextSelectColorResource(int resId) {
		this.tabTextSelectColor = getResources().getColor(resId);
	}
